...
3. Input your `current password`, the `new password` and finally input the `new password` again to confirm. You may click on the `eye` icon to view your password.
